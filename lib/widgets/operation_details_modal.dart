...
class _OperationDetailsModalState extends ConsumerState<OperationDetailsModal>
        ...
        children: [
          ...
          _buildInfoCard(
            ...
            [
              ...
              _buildInfoRow('Status Pagto', widget.operation.commissionPaymentStatus ?? 'Pendente', valueColor: _getPaymentStatusColor(widget.operation.commissionPaymentStatus)),
          ...
          _buildInfoCard(
            ...
            Icons.info_outline,
            [
              _buildInfoRow('WhatsApp', widget.operation.whatsappMessageSent ? 'Enviado' : 'Não enviado', valueColor: _getWhatsAppStatusColor(widget.operation.whatsappMessageSent)),
              _buildInfoRow('Google Calendar', widget.operation.googleCalendarEventCreated ? 'Criado' : 'Não criado', valueColor: _getCalendarStatusColor(widget.operation.googleCalendarEventCreated)),
  ...
  Widget _buildInfoRow(String label, String value, {TextEditingController? controller, bool isEditable = false, Widget? customEditWidget, Color? valueColor}) {
    return Padding(
  ...
  Color _getWhatsAppStatusColor(bool sent) {
    return sent ? Colors.green : Colors.red;
  }

  Color _getCalendarStatusColor(bool created) {
    return created ? Colors.green : Colors.red;
  }
  ...
  Color _getPaymentStatusColor(String? status) {
    switch (status?.toLowerCase()) {
      ...
      case 'cancelled':
        return Colors.red;
      default:
        return Colors.orange; // Default para pendente
    }
  }
