...
class AppTheme {
  ...
  static const List<String> _fontFallbacks = [
    ...
    // Fontes do sistema como última opção - REMOVIDO HELVETICA
    'Arial',
    'sans-serif',
  ];
...
final ThemeData appWhiteTheme = AppTheme.lightTheme;
final ThemeData appDarkTheme = AppTheme.darkTheme;
