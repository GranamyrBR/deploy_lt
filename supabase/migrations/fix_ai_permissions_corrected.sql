-- 🔧 FIX CORRIGIDO PARA PERMISSÕES AI - EXECUTAR NO SUPABASE DASHBOARD
-- Corrigido: policyname ao invés de polname
...
-- ==============================================
-- REMOVER TODAS AS POLÍTICAS EXISTENTES (CORRIGIDO)
-- ==============================================
DO $$
DECLARE
